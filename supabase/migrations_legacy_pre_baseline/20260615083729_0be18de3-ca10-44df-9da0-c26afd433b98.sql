...
CREATE TRIGGER set_sticky_notes_updated_at BEFORE UPDATE ON public.sticky_notes
...
-- Auto-create profile + role on signup; first user becomes admin with community access
...
-- Storage policies for the private trade-screenshots bucket
-- Path convention: {user_id}/{trade_id}/{filename}
